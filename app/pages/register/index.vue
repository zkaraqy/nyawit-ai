      ...
      <div class="p-8 rounded-3xl bg-white/60 backdrop-blur-xl border border-white/80 shadow-2xl shadow-emerald-900/10 w-full">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-sm text-slate-500">
            Daftar sekarang untuk bergabung dengan revolusi investasi agrotech.
          </p>
        </div>
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          ...
          <div class="space-y-1.5">
            <label class="text-sm font-semibold text-slate-700 block ml-1">Password</label>
            <div class="relative group">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400 group-focus-within:text-emerald-500 transition-colors">
          ...
          <div class="flex items-start gap-2 ml-1 mt-2">
            <input type="checkbox" id="terms" required
              class="mt-1 w-4 h-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500 cursor-pointer" />
            <label for="terms" class="text-sm text-slate-600">
              Saya setuju dengan <a href="#" class="text-emerald-600 font-semibold hover:text-emerald-500">Syarat & Ketentuan</a> serta <a href="#" class="text-emerald-600 font-semibold hover:text-emerald-500">Kebijakan Privasi</a>.
            </label>
          </div>
        ...
        <p class="mt-8 text-center text-sm text-slate-600">
          Sudah punya akun?
          <NuxtLink to="/login" class="font-bold text-emerald-600 hover:text-emerald-500 transition-colors focus:outline-none">
            Masuk sekarang
          </NuxtLink>
        </p>
      </div>
